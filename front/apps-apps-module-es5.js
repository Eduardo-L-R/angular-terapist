...
var DisplayComponent = /** @class */ (function () {
    function DisplayComponent(route, http, sessionService) {
        this.route = route;
        this.http = http;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.http.get("http://localhost:8080/checkbox/" + caseParam, this.sessionService.httpOptions())
                    ...
                    JSON.parse(res.formulario).map(function (element) {
                        _this.htmlElement.push(element);
    ...
    DisplayComponent.prototype.preguntar = function (valor) {
        console.log(valor);
    };
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.submitLogin = function (evento) {
...
var FormMantenedorComponent = /** @class */ (function () {
    function FormMantenedorComponent(http, sessionService) {
        this.http = http;
        this.sessionService = sessionService;
        // varables display
    ...
    FormMantenedorComponent.prototype.ngAfterViewInit = function () {
    };
    // displays de elementos en el HTML
    FormMantenedorComponent.prototype.mostrarCartaFormularios = function () {
    ...
    FormMantenedorComponent.prototype.mostrarFormularioCrear = function () {
    ...
    FormMantenedorComponent.prototype.mostrarFormularioEditar = function () {
    ...
    FormMantenedorComponent.prototype.mostrarFormulario = function (casoFormulario) {
        ...
        this.http.get(configUrl, this.sessionService.httpOptions()).subscribe(function (res) {
            if (_this.viewCardFormBuilder === false) {
                ...
                _this.viewButtonsUpdate = true;
                setTimeout(function () {
                    _this.formularioConstructor = $(document.getElementById("build-wrap")).formBuilder({
    ...
    FormMantenedorComponent.prototype.crearInformacion = function (evento) {
        var _this = this;
            ...
            this.http.post('http://localhost:8080/checkbox', informacion_1, this.sessionService.httpOptions())
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            return [4 /*yield*/, informacion_1];
                        case 1:
                            _a.formData = _b.sent();
                            return [4 /*yield*/, this.mostrarFormulario(this.formNumber)];
                        case 2:
                            _b.sent();
                            this.displayFormularios = false;
                            this.formCreateForms = false;
    ...
    FormMantenedorComponent.prototype.modificarInformacion = function (evento) {
        var _this = this;
        this.formNumber = evento.target.seleccionCaso.value;
            ...
            this.http.get("http://localhost:8080/checkbox/" + this.formNumber, this.sessionService.httpOptions())
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            return [4 /*yield*/, (JSON.parse(res.formulario))];
                        case 1:
                            _a.formData = _b.sent();
                            return [4 /*yield*/, this.mostrarFormulario(this.formNumber)];
                        case 2:
    ...
    FormMantenedorComponent.prototype.actualizarInformacion = function () {
        var _this = this;
        var informacion = {
            nombre: this.formNumber,
        ...
        this.http.patch("http://localhost:8080/checkbox/" + this.formNumber, informacion, this.sessionService.httpOptions())
            ...
            if (_this.viewCardFormBuilder === true) {
                _this.formularioConstructor = '';
                _this.viewCardFormBuilder = false;
            }
    ...
    return FormMantenedorComponent;
}());
...
var ViewFormsComponent = /** @class */ (function () {
    function ViewFormsComponent(http, sessionService) {
        this.http = http;
        this.sessionService = sessionService;
        // varables display
        this.viewCardFormBuilder = false;
    ...
    ViewFormsComponent.prototype.ngAfterViewInit = function () {
        ...
        this.http.get('http://localhost:8080/checkbox', this.sessionService.httpOptions())
            ...
            res.map(function (element) {
                ...
                _this.formElements.push(element.nombre);
            });
        });
    };
    ViewFormsComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
        { type: _services_session_service__WEBPACK_IMPORTED_MODULE_0__["SessionService"] }
    ]; };
...
var SessionGuard = /** @class */ (function () {
    function SessionGuard(http, sesionService, router) {
        this.http = http;
    ...
    SessionGuard.prototype.reedirigirALogin = function () {
        this.router.navigateByUrl("/apps/login");
    };
    SessionGuard.ctorParameters = function () { return [
...
var SessionService = /** @class */ (function () {
    ...
    SessionService.prototype.login = function (sesion) {
        ...
        this.http.post(this.url + "login", {
            ...
            _this.router.navigateByUrl("/apps/form-composer");
        });
    };
    SessionService.prototype.logout = function () {
        this.limpiarToken();
    };
    SessionService.prototype.limpiarToken = function () {
        localStorage.removeItem('authorization');
    };
    SessionService.prototype.leerToken = function () {
    ...
    //   ) as Observable<any>
    // }
    SessionService.prototype.estaAutenticado = function () {
        return this.http.post(this.url + "login", null, this.httpOptions());
    };
    SessionService.prototype.httpOptions = function () {
    ...
    ;
    SessionService.prototype.headerToken = function (valor) {
